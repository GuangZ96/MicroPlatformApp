<?php
	...
	$insert = "insert into ptinfo(okpttitle,okptdet) values('$name1','$name2')";
...
<html>
	...
	<body>
		...
		<div align="center">
			<button class="mui-btn mui-btn-blue" type="button" onclick="window.location.href='opera-parttime.php'">确定</button>
